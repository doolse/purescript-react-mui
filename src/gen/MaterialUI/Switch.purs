...
switch :: forall a. IsTSEq (Record a) (OptionRecord (SwitchPropsO SwitchPropsM) SwitchPropsM) => Record a -> Array ReactElement -> ReactElement
switch = unsafeCreateElement classSwitch

switch_ :: Array ReactElement -> ReactElement
switch_ = unsafeCreateElement classSwitch {}

switch' :: forall a. IsTSEq (Record a) (OptionRecord (SwitchPropsO SwitchPropsM) SwitchPropsM) => Record a -> ReactElement
switch' = unsafeCreateLeafElement classSwitch

switch'' :: forall a. IsTSEq (Record a) (OptionRecord (SwitchPropsO (SwitchPropsE SwitchPropsM)) SwitchPropsM) => Record a -> Array ReactElement -> ReactElement
switch'' = unsafeCreateElement classSwitch