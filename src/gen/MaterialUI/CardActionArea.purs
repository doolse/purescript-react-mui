module MaterialUI.CardActionArea where
...
cardActionArea :: forall a. IsTSEq (Record a) (OptionRecord (CardActionAreaPropsO CardActionAreaPropsM) CardActionAreaPropsM) => Record a -> Array ReactElement -> ReactElement
cardActionArea = unsafeCreateElement classCardActionArea

cardActionArea_ :: Array ReactElement -> ReactElement
cardActionArea_ = unsafeCreateElement classCardActionArea {}

cardActionArea' :: forall a. IsTSEq (Record a) (OptionRecord (CardActionAreaPropsO CardActionAreaPropsM) CardActionAreaPropsM) => Record a -> ReactElement
cardActionArea' = unsafeCreateLeafElement classCardActionArea

cardActionArea'' :: forall a. IsTSEq (Record a) (OptionRecord (CardActionAreaPropsO (CardActionAreaPropsE CardActionAreaPropsM)) CardActionAreaPropsM) => Record a -> Array ReactElement -> ReactElement
cardActionArea'' = unsafeCreateElement classCardActionArea