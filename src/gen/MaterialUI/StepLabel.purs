...
stepLabel :: forall a. IsTSEq (Record a) (OptionRecord (StepLabelPropsO StepLabelPropsM) StepLabelPropsM) => Record a -> Array ReactElement -> ReactElement
stepLabel = unsafeCreateElement classStepLabel

stepLabel_ :: Array ReactElement -> ReactElement
stepLabel_ = unsafeCreateElement classStepLabel {}

stepLabel' :: forall a. IsTSEq (Record a) (OptionRecord (StepLabelPropsO StepLabelPropsM) StepLabelPropsM) => Record a -> ReactElement
stepLabel' = unsafeCreateLeafElement classStepLabel

stepLabel'' :: forall a. IsTSEq (Record a) (OptionRecord (StepLabelPropsO (StepLabelPropsE StepLabelPropsM)) StepLabelPropsM) => Record a -> Array ReactElement -> ReactElement
stepLabel'' = unsafeCreateElement classStepLabel