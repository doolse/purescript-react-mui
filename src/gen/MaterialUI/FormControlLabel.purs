...
type FormControlLabelPropsO r = (innerRef :: OneOf ((typed :: Any{-- React.RefObject<any>--},
  typed :: String,
  typed :: Any -> Any)),
  ...
  labelPlacement :: OneOf ((typed :: StringConst "start",
...
type FormControlLabelPropsM  = (label :: ReactNode,
