module MaterialUI.OutlinedTextField where
...
foreign import classOutlinedTextField :: forall a. ReactClass a

type OutlinedTextFieldPropsO r = (
  key :: OneOf (
    typed :: String, 
    typed :: Number
  ), 
...
type OutlinedTextFieldPropsM  = (
  variant :: StringConst "outlined"
)

type OutlinedTextFieldPropsE r = (
...
outlinedTextField :: forall a. IsTSEq (Record a) (OptionRecord (OutlinedTextFieldPropsO OutlinedTextFieldPropsM) OutlinedTextFieldPropsM) => Record a -> Array ReactElement -> ReactElement
outlinedTextField = unsafeCreateElement classOutlinedTextField

outlinedTextField_ :: Array ReactElement -> ReactElement
outlinedTextField_ = unsafeCreateElement classOutlinedTextField {}

outlinedTextField' :: forall a. IsTSEq (Record a) (OptionRecord (OutlinedTextFieldPropsO OutlinedTextFieldPropsM) OutlinedTextFieldPropsM) => Record a -> ReactElement
outlinedTextField' = unsafeCreateLeafElement classOutlinedTextField

outlinedTextField'' :: forall a. IsTSEq (Record a) (OptionRecord (OutlinedTextFieldPropsO (OutlinedTextFieldPropsE OutlinedTextFieldPropsM)) OutlinedTextFieldPropsM) => Record a -> Array ReactElement -> ReactElement
outlinedTextField'' = unsafeCreateElement classOutlinedTextField