...
type ListItemTextPropsO r = (
  ...
  inset :: Boolean, 
  primary :: ReactNode, 
  primaryTypographyProps :: Any {-- unknown--}, 
  secondary :: ReactNode, 
  secondaryTypographyProps :: Any {-- unknown--}, 
  color :: String, 
  hidden :: Boolean, 
...
type ListItemTextPropsM  = (
)

type ListItemTextPropsE r = (
...
listItemText :: forall a. IsTSEq (Record a) (OptionRecord (ListItemTextPropsO ListItemTextPropsM) ListItemTextPropsM) => Record a -> Array ReactElement -> ReactElement
listItemText = unsafeCreateElement classListItemText

listItemText_ :: Array ReactElement -> ReactElement
listItemText_ = unsafeCreateElement classListItemText {}

listItemText' :: forall a. IsTSEq (Record a) (OptionRecord (ListItemTextPropsO ListItemTextPropsM) ListItemTextPropsM) => Record a -> ReactElement
listItemText' = unsafeCreateLeafElement classListItemText

listItemText'' :: forall a. IsTSEq (Record a) (OptionRecord (ListItemTextPropsO (ListItemTextPropsE ListItemTextPropsM)) ListItemTextPropsM) => Record a -> Array ReactElement -> ReactElement
listItemText'' = unsafeCreateElement classListItemText