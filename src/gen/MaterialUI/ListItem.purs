...
type ListItemPropsO r = (classes :: Any{-- unknown--},
  key :: OneOf ((typed :: Number,
  typed :: String)),
  button :: Boolean,
  component :: OneOf ((typed :: Any{-- (props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/ListItem/ListItem".ListItemProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--},
  typed :: String,
  ...
  "ContainerComponent" :: OneOf ((typed :: Any{-- (props: React.HTMLAttributes<interface HTMLDivElement> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--},
  typed :: String,
  ...
  formTarget :: String,
  name :: String,
  value :: OneOf ((typed :: Array String,
  typed :: String,
  typed :: Number)),
