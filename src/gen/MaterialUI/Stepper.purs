...
stepper :: forall a. IsTSEq (Record a) (OptionRecord (StepperPropsO StepperPropsM) StepperPropsM) => Record a -> Array ReactElement -> ReactElement
stepper = unsafeCreateElement classStepper

stepper_ :: Array ReactElement -> ReactElement
stepper_ = unsafeCreateElement classStepper {}

stepper' :: forall a. IsTSEq (Record a) (OptionRecord (StepperPropsO StepperPropsM) StepperPropsM) => Record a -> ReactElement
stepper' = unsafeCreateLeafElement classStepper

stepper'' :: forall a. IsTSEq (Record a) (OptionRecord (StepperPropsO (StepperPropsE StepperPropsM)) StepperPropsM) => Record a -> Array ReactElement -> ReactElement
stepper'' = unsafeCreateElement classStepper