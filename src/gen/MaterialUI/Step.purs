...
step :: forall a. IsTSEq (Record a) (OptionRecord (StepPropsO StepPropsM) StepPropsM) => Record a -> Array ReactElement -> ReactElement
step = unsafeCreateElement classStep

step_ :: Array ReactElement -> ReactElement
step_ = unsafeCreateElement classStep {}

step' :: forall a. IsTSEq (Record a) (OptionRecord (StepPropsO StepPropsM) StepPropsM) => Record a -> ReactElement
step' = unsafeCreateLeafElement classStep

step'' :: forall a. IsTSEq (Record a) (OptionRecord (StepPropsO (StepPropsE StepPropsM)) StepPropsM) => Record a -> Array ReactElement -> ReactElement
step'' = unsafeCreateElement classStep