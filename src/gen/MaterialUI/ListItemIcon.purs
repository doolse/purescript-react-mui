...
listItemIcon'' :: forall a. IsTSEq (Record a) (OptionRecord (ListItemIconPropsO (ListItemIconPropsE ListItemIconPropsM)) ListItemIconPropsM) => Record a -> ReactElement -> ReactElement
listItemIcon'' = unsafeCreateElement classListItemIcon