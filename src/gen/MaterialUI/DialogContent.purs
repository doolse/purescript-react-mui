...
type DialogContentPropsM  = (
)

type DialogContentPropsE r = (
...
dialogContent :: forall a. IsTSEq (Record a) (OptionRecord (DialogContentPropsO DialogContentPropsM) DialogContentPropsM) => Record a -> Array ReactElement -> ReactElement
...
dialogContent' :: forall a. IsTSEq (Record a) (OptionRecord (DialogContentPropsO DialogContentPropsM) DialogContentPropsM) => Record a -> ReactElement
dialogContent' = unsafeCreateLeafElement classDialogContent

dialogContent'' :: forall a. IsTSEq (Record a) (OptionRecord (DialogContentPropsO (DialogContentPropsE DialogContentPropsM)) DialogContentPropsM) => Record a -> Array ReactElement -> ReactElement
dialogContent'' = unsafeCreateElement classDialogContent