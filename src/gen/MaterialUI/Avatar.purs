...
type AvatarPropsO r = (
  ...
  component :: OneOf (
    typed :: String, 
    typed :: Any {-- React.ComponentClass<"/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Avatar/Avatar".AvatarProps<>, any>--}, 
    typed :: Any {-- (props: "/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Avatar/Avatar".AvatarProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
  imgProps :: Any {-- React.HtmlHTMLAttributes<interface HTMLImageElement>--}, 
  sizes :: String, 
  src :: String, 
  srcSet :: String, 
  color :: String, 
...
avatar :: forall a. IsTSEq (Record a) (OptionRecord (AvatarPropsO AvatarPropsM) AvatarPropsM) => Record a -> Array ReactElement -> ReactElement
avatar = unsafeCreateElement classAvatar

avatar_ :: Array ReactElement -> ReactElement
avatar_ = unsafeCreateElement classAvatar {}

avatar' :: forall a. IsTSEq (Record a) (OptionRecord (AvatarPropsO AvatarPropsM) AvatarPropsM) => Record a -> ReactElement
avatar' = unsafeCreateLeafElement classAvatar

avatar'' :: forall a. IsTSEq (Record a) (OptionRecord (AvatarPropsO (AvatarPropsE AvatarPropsM)) AvatarPropsM) => Record a -> Array ReactElement -> ReactElement
avatar'' = unsafeCreateElement classAvatar