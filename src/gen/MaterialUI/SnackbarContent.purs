...
type SnackbarContentPropsO r = (
  ...
  component :: OneOf (
    typed :: String, 
    typed :: Any {-- React.ComponentClass<"/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Paper/Paper".PaperProps<>, any>--}, 
    typed :: Any {-- (props: "/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Paper/Paper".PaperProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
  elevation :: Number, 
  square :: Boolean, 
  innerRef :: OneOf (
...
snackbarContent :: forall a. IsTSEq (Record a) (OptionRecord (SnackbarContentPropsO SnackbarContentPropsM) SnackbarContentPropsM) => Record a -> Array ReactElement -> ReactElement
snackbarContent = unsafeCreateElement classSnackbarContent

snackbarContent_ :: Array ReactElement -> ReactElement
snackbarContent_ = unsafeCreateElement classSnackbarContent {}

snackbarContent' :: forall a. IsTSEq (Record a) (OptionRecord (SnackbarContentPropsO SnackbarContentPropsM) SnackbarContentPropsM) => Record a -> ReactElement
snackbarContent' = unsafeCreateLeafElement classSnackbarContent

snackbarContent'' :: forall a. IsTSEq (Record a) (OptionRecord (SnackbarContentPropsO (SnackbarContentPropsE SnackbarContentPropsM)) SnackbarContentPropsM) => Record a -> Array ReactElement -> ReactElement
snackbarContent'' = unsafeCreateElement classSnackbarContent