...
type TypographyPropsO r = (
  ...
  component :: OneOf (
    ...
    typed :: Any {-- (props: "/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Typography/Typography".TypographyProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
...
typography :: forall a. IsTSEq (Record a) (OptionRecord (TypographyPropsO TypographyPropsM) TypographyPropsM) => Record a -> Array ReactElement -> ReactElement
...
typography' :: forall a. IsTSEq (Record a) (OptionRecord (TypographyPropsO TypographyPropsM) TypographyPropsM) => Record a -> ReactElement
typography' = unsafeCreateLeafElement classTypography

typography'' :: forall a. IsTSEq (Record a) (OptionRecord (TypographyPropsO (TypographyPropsE TypographyPropsM)) TypographyPropsM) => Record a -> Array ReactElement -> ReactElement
typography'' = unsafeCreateElement classTypography