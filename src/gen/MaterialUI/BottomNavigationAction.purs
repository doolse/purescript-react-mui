module MaterialUI.BottomNavigationAction where
...
bottomNavigationAction_ :: Array ReactElement -> ReactElement
bottomNavigationAction_ = unsafeCreateElement classBottomNavigationAction {}
