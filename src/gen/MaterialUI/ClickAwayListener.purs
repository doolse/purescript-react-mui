...
type ClickAwayListenerPropsO r = (touchEvent :: OneOf ((typed :: StringConst "onTouchStart",
  typed :: Any{-- false--},
  typed :: StringConst "onTouchEnd")),
  key :: OneOf ((typed :: Number,
  typed :: String)),
  mouseEvent :: OneOf ((typed :: StringConst "onMouseUp",
  typed :: Any{-- false--},
  typed :: StringConst "onClick",
  typed :: StringConst "onMouseDown")) | r)

type ClickAwayListenerPropsM  = (onClickAway :: EffectFn1 SyntheticEvent Unit)
