...
swipeableDrawer'' :: forall a. IsTSEq (Record a) (OptionRecord (SwipeableDrawerPropsO (SwipeableDrawerPropsE SwipeableDrawerPropsM)) SwipeableDrawerPropsM) => Record a -> Array ReactElement -> ReactElement
swipeableDrawer'' = unsafeCreateElement classSwipeableDrawer