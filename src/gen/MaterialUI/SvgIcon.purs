...
svgIcon'' :: forall a. IsTSEq (Record a) (OptionRecord (SvgIconPropsO (SvgIconPropsE SvgIconPropsM)) SvgIconPropsM) => Record a -> Array ReactElement -> ReactElement
svgIcon'' = unsafeCreateElement classSvgIcon