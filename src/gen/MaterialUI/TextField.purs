...
textField'' :: forall a. IsTSEq (Record a) (OptionRecord (TextFieldPropsO (TextFieldPropsE TextFieldPropsM)) TextFieldPropsM) => Record a -> Array ReactElement -> ReactElement
textField'' = unsafeCreateElement classTextField