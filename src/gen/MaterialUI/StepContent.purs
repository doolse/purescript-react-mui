...
type StepContentPropsO r = (innerRef :: OneOf ((typed :: Any{-- React.RefObject<any>--},
  typed :: String,
  typed :: Any -> Any)),
  ...
  last :: Boolean,
  optional :: Boolean,
  orientation :: OneOf ((typed :: StringConst "vertical",
  typed :: StringConst "horizontal")),
  "TransitionComponent" :: OneOf ((typed :: Any{-- (props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/transitions/transition".TransitionProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--},
