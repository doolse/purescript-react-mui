...
type StepContentPropsO r = (
  ...
  "TransitionComponent" :: OneOf (
    typed :: Any {-- React.ComponentClass<"/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/transitions/transition".TransitionProps<>, any>--}, 
    typed :: Any {-- (props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/transitions/transition".TransitionProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
...
stepContent :: forall a. IsTSEq (Record a) (OptionRecord (StepContentPropsO StepContentPropsM) StepContentPropsM) => Record a -> Array ReactElement -> ReactElement
stepContent = unsafeCreateElement classStepContent

stepContent_ :: Array ReactElement -> ReactElement
stepContent_ = unsafeCreateElement classStepContent {}

stepContent' :: forall a. IsTSEq (Record a) (OptionRecord (StepContentPropsO StepContentPropsM) StepContentPropsM) => Record a -> ReactElement
stepContent' = unsafeCreateLeafElement classStepContent

stepContent'' :: forall a. IsTSEq (Record a) (OptionRecord (StepContentPropsO (StepContentPropsE StepContentPropsM)) StepContentPropsM) => Record a -> Array ReactElement -> ReactElement
stepContent'' = unsafeCreateElement classStepContent