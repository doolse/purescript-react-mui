...
type CardHeaderPropsO r = (
  ...
  component :: OneOf (
    typed :: String, 
    typed :: Any {-- React.ComponentClass<"/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/CardHeader/CardHeader".CardHeaderProps<>, any>--}, 
    typed :: Any {-- (props: "/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/CardHeader/CardHeader".CardHeaderProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
  disableTypography :: Boolean, 
  subheader :: ReactNode, 
  subheaderTypographyProps :: Any {-- unknown--}, 
  title :: ReactNode, 
  titleTypographyProps :: Any {-- unknown--}, 
  color :: String, 
  hidden :: Boolean, 
...
cardHeader :: forall a. IsTSEq (Record a) (OptionRecord (CardHeaderPropsO CardHeaderPropsM) CardHeaderPropsM) => Record a -> Array ReactElement -> ReactElement
...
cardHeader' :: forall a. IsTSEq (Record a) (OptionRecord (CardHeaderPropsO CardHeaderPropsM) CardHeaderPropsM) => Record a -> ReactElement
cardHeader' = unsafeCreateLeafElement classCardHeader

cardHeader'' :: forall a. IsTSEq (Record a) (OptionRecord (CardHeaderPropsO (CardHeaderPropsE CardHeaderPropsM)) CardHeaderPropsM) => Record a -> Array ReactElement -> ReactElement
cardHeader'' = unsafeCreateElement classCardHeader