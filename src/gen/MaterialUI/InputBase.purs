module MaterialUI.InputBase where
...
inputBase :: forall a. IsTSEq (Record a) (OptionRecord (InputBasePropsO InputBasePropsM) InputBasePropsM) => Record a -> Array ReactElement -> ReactElement
inputBase = unsafeCreateElement classInputBase

inputBase_ :: Array ReactElement -> ReactElement
inputBase_ = unsafeCreateElement classInputBase {}

inputBase' :: forall a. IsTSEq (Record a) (OptionRecord (InputBasePropsO InputBasePropsM) InputBasePropsM) => Record a -> ReactElement
inputBase' = unsafeCreateLeafElement classInputBase

inputBase'' :: forall a. IsTSEq (Record a) (OptionRecord (InputBasePropsO (InputBasePropsE InputBasePropsM)) InputBasePropsM) => Record a -> Array ReactElement -> ReactElement
inputBase'' = unsafeCreateElement classInputBase