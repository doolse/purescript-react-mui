...
type NativeSelectInputPropsO r = (variant :: OneOf ((typed :: StringConst "standard",
  ...
  inputRef :: EffectFn1 (OneOf ((typed :: Record ((value :: OneOf ((typed :: Number,
  typed :: Boolean,
  typed :: Any{-- undefined--},
  typed :: String)),
