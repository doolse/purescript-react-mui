...
dialogTitle :: forall a. IsTSEq (Record a) (OptionRecord (DialogTitlePropsO DialogTitlePropsM) DialogTitlePropsM) => Record a -> Array ReactElement -> ReactElement
dialogTitle = unsafeCreateElement classDialogTitle

dialogTitle_ :: Array ReactElement -> ReactElement
dialogTitle_ = unsafeCreateElement classDialogTitle {}

dialogTitle' :: forall a. IsTSEq (Record a) (OptionRecord (DialogTitlePropsO DialogTitlePropsM) DialogTitlePropsM) => Record a -> ReactElement
dialogTitle' = unsafeCreateLeafElement classDialogTitle

dialogTitle'' :: forall a. IsTSEq (Record a) (OptionRecord (DialogTitlePropsO (DialogTitlePropsE DialogTitlePropsM)) DialogTitlePropsM) => Record a -> Array ReactElement -> ReactElement
dialogTitle'' = unsafeCreateElement classDialogTitle