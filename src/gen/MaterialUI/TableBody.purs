...
tableBody :: forall a. IsTSEq (Record a) (OptionRecord (TableBodyPropsO TableBodyPropsM) TableBodyPropsM) => Record a -> Array ReactElement -> ReactElement
tableBody = unsafeCreateElement classTableBody

tableBody_ :: Array ReactElement -> ReactElement
tableBody_ = unsafeCreateElement classTableBody {}

tableBody' :: forall a. IsTSEq (Record a) (OptionRecord (TableBodyPropsO TableBodyPropsM) TableBodyPropsM) => Record a -> ReactElement
tableBody' = unsafeCreateLeafElement classTableBody

tableBody'' :: forall a. IsTSEq (Record a) (OptionRecord (TableBodyPropsO (TableBodyPropsE TableBodyPropsM)) TableBodyPropsM) => Record a -> Array ReactElement -> ReactElement
tableBody'' = unsafeCreateElement classTableBody