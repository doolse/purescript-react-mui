...
dialogActions :: forall a. IsTSEq (Record a) (OptionRecord (DialogActionsPropsO DialogActionsPropsM) DialogActionsPropsM) => Record a -> Array ReactElement -> ReactElement
...
dialogActions' :: forall a. IsTSEq (Record a) (OptionRecord (DialogActionsPropsO DialogActionsPropsM) DialogActionsPropsM) => Record a -> ReactElement
dialogActions' = unsafeCreateLeafElement classDialogActions

dialogActions'' :: forall a. IsTSEq (Record a) (OptionRecord (DialogActionsPropsO (DialogActionsPropsE DialogActionsPropsM)) DialogActionsPropsM) => Record a -> Array ReactElement -> ReactElement
dialogActions'' = unsafeCreateElement classDialogActions