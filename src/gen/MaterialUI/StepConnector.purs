module MaterialUI.StepConnector where
...
stepConnector :: forall a. IsTSEq (Record a) (OptionRecord (StepConnectorPropsO StepConnectorPropsM) StepConnectorPropsM) => Record a -> Array ReactElement -> ReactElement
stepConnector = unsafeCreateElement classStepConnector

stepConnector_ :: Array ReactElement -> ReactElement
stepConnector_ = unsafeCreateElement classStepConnector {}

stepConnector' :: forall a. IsTSEq (Record a) (OptionRecord (StepConnectorPropsO StepConnectorPropsM) StepConnectorPropsM) => Record a -> ReactElement
stepConnector' = unsafeCreateLeafElement classStepConnector

stepConnector'' :: forall a. IsTSEq (Record a) (OptionRecord (StepConnectorPropsO (StepConnectorPropsE StepConnectorPropsM)) StepConnectorPropsM) => Record a -> Array ReactElement -> ReactElement
stepConnector'' = unsafeCreateElement classStepConnector