...
linearProgress'' :: forall a. IsTSEq (Record a) (OptionRecord (LinearProgressPropsO (LinearProgressPropsE LinearProgressPropsM)) LinearProgressPropsM) => Record a -> Array ReactElement -> ReactElement
linearProgress'' = unsafeCreateElement classLinearProgress