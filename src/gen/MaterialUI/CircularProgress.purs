...
circularProgress :: forall a. IsTSEq (Record a) (OptionRecord (CircularProgressPropsO CircularProgressPropsM) CircularProgressPropsM) => Record a -> Array ReactElement -> ReactElement
...
circularProgress' :: forall a. IsTSEq (Record a) (OptionRecord (CircularProgressPropsO CircularProgressPropsM) CircularProgressPropsM) => Record a -> ReactElement
circularProgress' = unsafeCreateLeafElement classCircularProgress

circularProgress'' :: forall a. IsTSEq (Record a) (OptionRecord (CircularProgressPropsO (CircularProgressPropsE CircularProgressPropsM)) CircularProgressPropsM) => Record a -> Array ReactElement -> ReactElement
circularProgress'' = unsafeCreateElement classCircularProgress