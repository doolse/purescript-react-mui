...
card :: forall a. IsTSEq (Record a) (OptionRecord (CardPropsO CardPropsM) CardPropsM) => Record a -> Array ReactElement -> ReactElement
card = unsafeCreateElement classCard

card_ :: Array ReactElement -> ReactElement
card_ = unsafeCreateElement classCard {}

card' :: forall a. IsTSEq (Record a) (OptionRecord (CardPropsO CardPropsM) CardPropsM) => Record a -> ReactElement
card' = unsafeCreateLeafElement classCard

card'' :: forall a. IsTSEq (Record a) (OptionRecord (CardPropsO (CardPropsE CardPropsM)) CardPropsM) => Record a -> Array ReactElement -> ReactElement
card'' = unsafeCreateElement classCard