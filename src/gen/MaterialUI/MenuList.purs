...
type MenuListPropsO r = (
  ...
  component :: OneOf (
    typed :: String, 
    typed :: Any {-- React.ComponentClass<"/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/List/List".ListProps<>, any>--}, 
    typed :: Any {-- (props: "/home/doolse/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/List/List".ListProps<> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
  innerRef :: OneOf (
    typed :: String, 
    typed :: Any -> Any, 
...
menuList :: forall a. IsTSEq (Record a) (OptionRecord (MenuListPropsO MenuListPropsM) MenuListPropsM) => Record a -> Array ReactElement -> ReactElement
menuList = unsafeCreateElement classMenuList

menuList_ :: Array ReactElement -> ReactElement
menuList_ = unsafeCreateElement classMenuList {}

menuList' :: forall a. IsTSEq (Record a) (OptionRecord (MenuListPropsO MenuListPropsM) MenuListPropsM) => Record a -> ReactElement
menuList' = unsafeCreateLeafElement classMenuList

menuList'' :: forall a. IsTSEq (Record a) (OptionRecord (MenuListPropsO (MenuListPropsE MenuListPropsM)) MenuListPropsM) => Record a -> Array ReactElement -> ReactElement
menuList'' = unsafeCreateElement classMenuList