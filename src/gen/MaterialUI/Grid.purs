...
type GridPropsO r = (innerRef :: OneOf ((typed :: Any{-- React.RefObject<any>--},
  typed :: String,
  typed :: Any -> Any)),
  key :: OneOf ((typed :: Number,
  typed :: String)),
  alignContent :: OneOf ((typed :: StringConst "flex-start",
  ...
  alignItems :: OneOf ((typed :: StringConst "baseline",
  typed :: StringConst "stretch",
  typed :: StringConst "center",
  typed :: StringConst "flex-end",
  typed :: StringConst "flex-start")),
  component :: OneOf ((typed :: Any{-- (props: unknown | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--},
  typed :: String,
  typed :: Any{-- React.ComponentClass<unknown, any>--})),
  container :: Boolean,
  direction :: OneOf ((typed :: StringConst "row-reverse",
  typed :: StringConst "column",
  typed :: StringConst "column-reverse",
  typed :: StringConst "row")),
  item :: Boolean,
  justify :: OneOf ((typed :: StringConst "flex-start",
  typed :: StringConst "space-around",
  typed :: StringConst "space-between",
  typed :: StringConst "space-evenly",
  typed :: StringConst "center",
  typed :: StringConst "flex-end")),
  spacing :: OneOf ((typed :: Any{-- 40.0--},
  typed :: Any{-- 0.0--},
  typed :: Any{-- 8.0--},
  typed :: Any{-- 16.0--},
  typed :: Any{-- 24.0--},
  typed :: Any{-- 32.0--})),
  wrap :: OneOf ((typed :: StringConst "wrap-reverse",
