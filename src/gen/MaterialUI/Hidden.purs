...
type HiddenPropsO r = (style :: Any{-- React.CSSProperties<>--},
  key :: OneOf ((typed :: Number,
  typed :: String)),
  implementation :: OneOf ((typed :: StringConst "css",
  typed :: StringConst "js")),
  initialWidth :: OneOf ((typed :: StringConst "xl",
  ...
  mdDown :: Boolean,
  mdUp :: Boolean,
  only :: OneOf ((typed :: Array Any{-- "\"/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/styles/createBreakpoints\".Breakpoint"--},
  typed :: StringConst "xs",
  typed :: StringConst "sm",
  typed :: StringConst "md",
  typed :: StringConst "lg",
