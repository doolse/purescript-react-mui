module MaterialUI.BaseTextField where
...
foreign import classBaseTextField :: forall a. ReactClass a

type BaseTextFieldPropsO r = (
  key :: OneOf (
    typed :: String, 
    typed :: Number
  ), 
...
type BaseTextFieldPropsM  = (
)

type BaseTextFieldPropsE r = (
...
baseTextField :: forall a. IsTSEq (Record a) (OptionRecord (BaseTextFieldPropsO BaseTextFieldPropsM) BaseTextFieldPropsM) => Record a -> Array ReactElement -> ReactElement
baseTextField = unsafeCreateElement classBaseTextField

baseTextField_ :: Array ReactElement -> ReactElement
baseTextField_ = unsafeCreateElement classBaseTextField {}

baseTextField' :: forall a. IsTSEq (Record a) (OptionRecord (BaseTextFieldPropsO BaseTextFieldPropsM) BaseTextFieldPropsM) => Record a -> ReactElement
baseTextField' = unsafeCreateLeafElement classBaseTextField

baseTextField'' :: forall a. IsTSEq (Record a) (OptionRecord (BaseTextFieldPropsO (BaseTextFieldPropsE BaseTextFieldPropsM)) BaseTextFieldPropsM) => Record a -> Array ReactElement -> ReactElement
baseTextField'' = unsafeCreateElement classBaseTextField