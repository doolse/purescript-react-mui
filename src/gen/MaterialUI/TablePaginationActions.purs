...
type TablePaginationActionsPropsO r = (onTransitionEndCapture :: EffectFn1 SyntheticTransitionEvent Unit,
  ...
  onTransitionEnd :: EffectFn1 SyntheticTransitionEvent Unit | r)

type TablePaginationActionsPropsM  = (rowsPerPage :: Number,
  count :: Number,
