...
type TableCellPropsO r = (
  ...
  component :: OneOf (
    ...
    typed :: Any {-- (props: React.ThHTMLAttributes<interface HTMLTableHeaderCellElement> | React.TdHTMLAttributes<interface HTMLTableDataCellElement> | {children: boolean | undefined | null | string | number | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--}
  ), 
  numeric :: Boolean, 
  padding :: OneOf (
...
tableCell'' :: forall a. IsTSEq (Record a) (OptionRecord (TableCellPropsO (TableCellPropsE TableCellPropsM)) TableCellPropsM) => Record a -> Array ReactElement -> ReactElement
tableCell'' = unsafeCreateElement classTableCell