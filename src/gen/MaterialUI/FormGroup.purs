...
formGroup :: forall a. IsTSEq (Record a) (OptionRecord (FormGroupPropsO FormGroupPropsM) FormGroupPropsM) => Record a -> Array ReactElement -> ReactElement
formGroup = unsafeCreateElement classFormGroup

formGroup_ :: Array ReactElement -> ReactElement
formGroup_ = unsafeCreateElement classFormGroup {}

formGroup' :: forall a. IsTSEq (Record a) (OptionRecord (FormGroupPropsO FormGroupPropsM) FormGroupPropsM) => Record a -> ReactElement
formGroup' = unsafeCreateLeafElement classFormGroup

formGroup'' :: forall a. IsTSEq (Record a) (OptionRecord (FormGroupPropsO (FormGroupPropsE FormGroupPropsM)) FormGroupPropsM) => Record a -> Array ReactElement -> ReactElement
formGroup'' = unsafeCreateElement classFormGroup