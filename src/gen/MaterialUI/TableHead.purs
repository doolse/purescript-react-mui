...
foreign import classTableHead :: forall a. ReactClass a
...
tableHead :: forall a. IsTSEq (Record a) (OptionRecord (TableHeadPropsO TableHeadPropsM) TableHeadPropsM) => Record a -> Array ReactElement -> ReactElement
tableHead = unsafeCreateElement classTableHead

tableHead_ :: Array ReactElement -> ReactElement
tableHead_ = unsafeCreateElement classTableHead {}

tableHead' :: forall a. IsTSEq (Record a) (OptionRecord (TableHeadPropsO TableHeadPropsM) TableHeadPropsM) => Record a -> ReactElement
tableHead' = unsafeCreateLeafElement classTableHead

tableHead'' :: forall a. IsTSEq (Record a) (OptionRecord (TableHeadPropsO (TableHeadPropsE TableHeadPropsM)) TableHeadPropsM) => Record a -> Array ReactElement -> ReactElement
tableHead'' = unsafeCreateElement classTableHead