...
type ChipPropsO r = (
  ...
  component :: OneOf ((
    ...
    typed :: Any {--(props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Chip/Chip".ChipProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  deleteIcon :: ReactElement,
  icon :: ReactElement,
  label :: ReactNode,
  onDelete :: EffectFn1 (Any {--any--}) Unit,
  variant :: OneOf ((
    typed :: StringConst ("default"),
