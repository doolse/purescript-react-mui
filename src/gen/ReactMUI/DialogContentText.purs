...
type DialogContentTextPropsO r = (
  ...
  component :: OneOf ((
    ...
    typed :: Any {--(props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/Typography/Typography".TypographyProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  innerRef :: OneOf ((
    typed :: String,
