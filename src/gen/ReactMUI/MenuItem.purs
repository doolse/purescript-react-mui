module ReactMUI.MenuItem where
...
type MenuItemPropsO r = (
  component :: OneOf ((
    ...
    typed :: Any {--(props: "/home/jolz/git/purescript-react-mui/synctypes/node_modules/@material-ui/core/es/MenuItem/MenuItem".MenuItemProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  role :: String,
  color :: String,
  hidden :: Boolean,
  ...
  "ContainerComponent" :: OneOf ((
    ...
    typed :: Any {--(props: React.HTMLAttributes<interface HTMLDivElement> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
...
foreign import menuItem :: forall a. IsTSRecord a (MenuItemPropsO MenuItemPropsM) MenuItemPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)
