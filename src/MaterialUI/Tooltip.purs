...
import Prelude
import MaterialUI.PropTypes (EventHandler, ReactNode, StandardPropsExt, class IsReactNode, Untyped)
import MaterialUI.Properties (Enum, mkProp, mkPropRecord, IProp)
...
tooltipU = unsafeCreateElement tooltipClass
