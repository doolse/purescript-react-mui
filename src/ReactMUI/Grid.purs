...
type GridPropsO r = (
  ...
  component :: OneOf ((
    ...
    typed :: Any {--(props: unknown | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  container :: Boolean,
  direction :: OneOf ((
