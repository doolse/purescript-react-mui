module ReactMUI.ToggleButton where
...
type ToggleButtonPropsO r = (
  component :: OneOf ((
    typed :: String,
    typed :: Any {--React.ComponentClass<"/home/jolz/git/material-ui/packages/material-ui-lab/src/ToggleButton/ToggleButton".ToggleButtonProps<>, any>--},
    typed :: Any {--(props: "/home/jolz/git/material-ui/packages/material-ui-lab/src/ToggleButton/ToggleButton".ToggleButtonProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  disabled :: Boolean,
...
type ToggleButtonPropsM  = (
)
foreign import toggleButton :: forall a. IsTSRecord a (ToggleButtonPropsO ToggleButtonPropsM) ToggleButtonPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)