module ReactMUI.SpeedDial where
...
type SpeedDialPropsO r = (
  ...
  "TransitionProps" :: Any {--interface "/home/jolz/git/material-ui/node_modules/@types/react-transition-group/Transition".TransitionProps--},
  color :: String,
...
type SpeedDialPropsM  = (
  icon :: ReactNode,
  open :: Boolean)
foreign import speedDial :: forall a. IsTSRecord a (SpeedDialPropsO SpeedDialPropsM) SpeedDialPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)