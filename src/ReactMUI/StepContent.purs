...
type StepContentPropsO r = (
  ...
  "TransitionComponent" :: OneOf ((
    typed :: Any {--React.ComponentClass<"/home/jolz/git/material-ui/packages/material-ui/src/transitions/transition".TransitionProps<>, any>--},
    typed :: Any {--(props: "/home/jolz/git/material-ui/packages/material-ui/src/transitions/transition".TransitionProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
