module ReactMUI.InputComponent where
...
type InputComponentPropsO r = (
  ...
  inputComponent :: OneOf ((
    typed :: String,
    typed :: Any {--React.ComponentClass<"/home/jolz/git/material-ui/packages/material-ui/src/Input/Input".InputComponentProps<>, any>--},
    typed :: Any {--(props: "/home/jolz/git/material-ui/packages/material-ui/src/Input/Input".InputComponentProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  inputProps :: Any {--"/home/jolz/git/material-ui/packages/material-ui/src/Input/Input".InputComponentProps<>--},
  inputRef :: OneOf ((
    typed :: String,
...
type InputComponentPropsM  = (
)
foreign import inputComponent :: forall a. IsTSRecord a (InputComponentPropsO InputComponentPropsM) InputComponentPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)