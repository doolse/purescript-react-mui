...
type TabsPropsO r = (
  action :: EffectFn1 (Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Tabs/Tabs".TabsActions--}) Unit,
  centered :: Boolean,
  component :: OneOf ((
    typed :: String,
    typed :: Any {--React.ComponentClass<"/home/jolz/git/material-ui/packages/material-ui/src/Tabs/Tabs".TabsProps<>, any>--},
    typed :: Any {--(props: "/home/jolz/git/material-ui/packages/material-ui/src/Tabs/Tabs".TabsProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  fullWidth :: Boolean,
