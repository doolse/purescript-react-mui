...
type SliderPropsO r = (
  ...
  step :: Number,
  value :: Number,
  onChange :: EffectFn2 (Any {--React.ChangeEvent<{}>--}) Number Unit,
  onDragEnd :: EffectFn1 (Any {--React.ChangeEvent<{}>--}) Unit,
  onDragStart :: EffectFn1 (Any {--React.ChangeEvent<{}>--}) Unit,
  color :: String,
  hidden :: Boolean,
...
foreign import slider :: forall a. IsTSRecord a (SliderPropsO SliderPropsM) SliderPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)