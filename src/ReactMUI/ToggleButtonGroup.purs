module ReactMUI.ToggleButtonGroup where
...
type ToggleButtonGroupPropsO r = (
  selected :: Boolean,
  exclusive :: Boolean,
  onChange :: EffectFn2 (Any {--React.MouseEvent<interface HTMLElement>--}) (Any {--any--}) Unit,
  value :: Any {--any--},
  color :: String,
  hidden :: Boolean,
...
type ToggleButtonGroupPropsM  = (
)
foreign import toggleButtonGroup :: forall a. IsTSRecord a (ToggleButtonGroupPropsO ToggleButtonGroupPropsM) ToggleButtonGroupPropsM => Function (Record a) (Function (Array ReactElement) ReactElement)