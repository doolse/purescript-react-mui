...
type PopoverPropsO r = (
  action :: EffectFn1 (Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Popover/Popover".PopoverActions--}) Unit,
  anchorEl :: OneOf ((
    typed :: Any {--interface HTMLElement--},
    typed :: Function (Any {--interface HTMLElement--}) (Any {--interface HTMLElement--}))),
  anchorOrigin :: Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Popover/Popover".PopoverOrigin--},
  anchorPosition :: Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Popover/Popover".PopoverPosition--},
  ...
  role :: String,
  transformOrigin :: Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Popover/Popover".PopoverOrigin--},
  ...
  onChange :: EffectFn1 (Any {--React.FormEvent<interface HTMLDivElement>--}) Unit,
  ...
  "BackdropComponent" :: OneOf ((
    typed :: String,
    typed :: Any {--React.ComponentClass<"/home/jolz/git/material-ui/packages/material-ui/src/Backdrop/Backdrop".BackdropProps<>, any>--},
    typed :: Any {--(props: "/home/jolz/git/material-ui/packages/material-ui/src/Backdrop/Backdrop".BackdropProps<> | {children: undefined | null | string | number | false | true | {} | React.ReactElement<any> | React.ReactNodeArray<> | React.ReactPortal<>}, context: any => null | React.ReactElement<any>)--})),
  ...
  onBackdropClick :: EffectFn1 (Any {--React.SyntheticEvent<{}>--}) Unit,
  onClose :: EffectFn1 (Any {--React.SyntheticEvent<{}>--}) Unit,
  onEscapeKeyDown :: EffectFn1 (Any {--React.SyntheticEvent<{}>--}) Unit,
