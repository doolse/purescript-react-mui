...
type SnackbarPropsO r = (
  action :: ReactNode,
  anchorOrigin :: Any {--interface "/home/jolz/git/material-ui/packages/material-ui/src/Snackbar/Snackbar".SnackbarOrigin--},
  autoHideDuration :: Number,
  "ClickAwayListenerProps" :: Any {--unknown--},
  "ContentProps" :: Any {--unknown--},
  disableWindowBlurListener :: Boolean,
  message :: ReactNode,
  onClose :: EffectFn2 (Any {--React.SyntheticEvent<any>--}) String Unit,
  onMouseEnter :: EffectFn1 (Any {--React.MouseEvent<any>--}) Unit,
  onMouseLeave :: EffectFn1 (Any {--React.MouseEvent<any>--}) Unit,
